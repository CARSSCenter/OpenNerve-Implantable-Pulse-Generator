...
<img width="1438" height="363" alt="Screenshot 2026-07-23 at 4 37 10 PM" src="https://github.com/user-attachments/assets/5219d872-509e-46af-a061-a0d7ba92aed8" />
...
We also designed a power delivery section of the board, which provides a stable 5 V supply for the sine wave generator. The board is powered through a USB-C connector. To provide a stable operating voltage  in the USB input a TPS63002 buck boost converter. This power converter  maintains a regulated 5 V output that powers the analog circuitry and provides the supply required to generate the 2.5 V virtual reference (Vref) used throughout the oscillator.
The power converter schematic was designed according to the Texas Instruments datasheet design including the recommended input/output decoupling capacitors, feedback network, and external inductor.

Before PCB fabrication, we recreated the power supply in LTspice to check the converter behavior and confirm that the circuit produced a regulated 5 V output under normal operating conditions. This simulation also allowed us to verify proper startup behavior and ensure that the supply would provide sufficient power for the oscillator. Simulating the power stage before PCB fabrication helped identify potential issues.
