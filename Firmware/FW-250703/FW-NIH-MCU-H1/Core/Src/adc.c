...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Pin = EMG1_OUT_Pin|ECG_RR_OUT_Pin|ECG_HR_OUT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /* USER CODE END ADC4_MspInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Pin = IMP_INA_Pin|IMP_INB_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOF, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = EMG2_OUT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(EMG2_OUT_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOB, EMG1_OUT_Pin|ECG_RR_OUT_Pin|ECG_HR_OUT_Pin);
  ...
  /* USER CODE END ADC4_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOF, IMP_INA_Pin|IMP_INB_Pin);

    HAL_GPIO_DeInit(EMG2_OUT_GPIO_Port, EMG2_OUT_Pin);
