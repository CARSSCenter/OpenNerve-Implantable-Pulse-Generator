...
#define LEN_BLE_ID_MAX			24U				/*!< The max length of the BLE ID */
...
typedef struct {
	...
	uint8_t	bleid[LEN_BLE_ID_MAX];				/*!< BLE ID for BLE advertising */
} BLE_ADV_Setting_t;
 ...
 * @param len_ble_id The length of BLE ID
 */
void app_func_ble_adv_start(BLE_ADV_Setting_t* p_setting, uint8_t len_ble_id);
