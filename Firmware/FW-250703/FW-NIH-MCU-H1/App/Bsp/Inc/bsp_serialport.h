 ...
 */
uint8_t bsp_sp_DAC80501_write(uint8_t reg_addr, uint8_t* reg_data);
 ...
 * @return uint8_t HAL status
 */
uint8_t bsp_sp_DAC80501_read(uint8_t reg_addr, uint8_t* reg_data);
 ...
 * @param reg_data The data to be written to the DAC80501 register
 */
void bsp_sp_DAC80501_write_IT(uint8_t reg_addr, uint8_t* reg_data);
